...
class TestIntegerList(TestCase):
    def setUp(self):
        self.integer_list = IntegerList("50", 1, 2, "Borislav", False, 3, 4.5)
    ...
    def test_insert_element_with_invalid_type_raise_value_error(self):
        with self.assertRaises(ValueError) as ve:
            self.integer_list.insert(2, "Bobi")

        self.assertEqual("Element is not Integer", str(ve.exception))

    def test_insert_with_valid_index_and_element(self):
    ...
    def test_get_element_by_index_correct(self):
