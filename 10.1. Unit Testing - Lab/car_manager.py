...
class TestCar(TestCase):
    ...
    def test_valid_fuel_consumption_raise_exception(self):
        self.assertEqual(15, self.car.fuel_consumption)

    def test_invalid_fuel_consumption_raise_exception(self):
        with self.assertRaises(Exception) as ex:
            self.car.fuel_consumption = 0

        self.assertEqual("Fuel consumption cannot be zero or negative!", str(ex.exception))

    def test_invalid_fuel_capacity_raise_exception(self):
        with self.assertRaises(Exception) as ex:
    ...
    def test_refuel_with_more_than_the_fuel_capacity(self):
