...
class Bookstore:
    def __init__(self, books_limit: int):    # Done
    ...
    def receive_book(self, book_title: str, number_of_books: int):
        ...
        if len(self) + number_of_books > self.books_limit:    # Done
            raise Exception("Books limit is reached. Cannot receive more books!")

        # if there is enough space in the bookstore
        if book_title not in self.availability_in_store_by_book_titles:    # Done
    ...
    def sell_book(self, book_title: str, number_of_books: int):
        ...
        if number_of_books > self.availability_in_store_by_book_titles[book_title]:    # Done
        ...
        self.availability_in_store_by_book_titles[book_title] -= number_of_books    # Done
